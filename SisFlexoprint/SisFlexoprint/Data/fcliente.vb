...
Public Class fcliente
    ...
    Public Function mostrarNombres() As DataTable
        Try
            conectado()
            cmd = New SqlCommand("SELECT nombre FROM cliente")
    ...
    Public Function eliminar(ByVal dts As vcliente) As Boolean
        ...
        Catch ex As Exception
            If ex.Message.ToString = "The DELETE statement conflicted with the REFERENCE constraint ""FK__venta__idcliente__3864608B"". The conflict occurred in database ""dbFlexoprint"", table ""dbo.venta"", column 'idcliente'." & vbNewLine & "The statement has been terminated." Then
